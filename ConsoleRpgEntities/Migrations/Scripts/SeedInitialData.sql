...
-- Weapons
INSERT INTO Items (Name, Description, ItemType, Weight, Value, ContainerId, Attack, Category, Slot)
VALUES
    ('Iron Shortsword', 'A reliable blade forged from plain iron.', 'Weapon', 4.00, 45, 1, 6, 'Melee', 'Weapon'),
    ('Ashwood Bow', 'A hunter''s bow made of supple ashwood.', 'Weapon', 2.50, 80, 1, 8, 'Ranged', 'Weapon'),
    ('Gnarled Staff', 'A twisted staff humming with faint magic.', 'Weapon', 3.00, 120, 1, 5, 'Magic', 'Weapon'),
    ('Rusty Dagger', 'Better than nothing. Barely.', 'Weapon', 1.00, 5, 1, 2, 'Melee', 'Weapon');
