...
-- Luke the Meister of Slime: An ancient slime that rests in the Hidden Shrine 
INSERT INTO Monsters 
    (Id, Name, Health, AggressionLevel, MonsterType, CurrentRoomId, LootId, IsLooted, GelatinousBile) 
VALUES 
    (4, 'Luke the Meister of Slime', 75, 4, 'Slime', 12, NULL, 0, 4);
